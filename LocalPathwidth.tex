...
\begin{proof}
  ...
  Contract the entire subtree comprised of the tree rooted at $a_2$,
  the subtree rooted at $a_3$ and the path from $a_2$ to $a_3$. Applying
  the same procedure recursively on $T_{2k-2}^+$ rooted at $a_1$ and
  $T_{2k-2}$ rooted at $a_4$ produces $Q_k$, as can be easily verified
  by induction.
\end{proof}
