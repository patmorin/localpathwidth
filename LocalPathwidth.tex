...
\section{A Conjecture and Some Proofs}
...
It is immediate that (5) implies (1).
...
\begin{proof}[Proof that (3) implies (5)] 
...
\begin{proof}[Proof that (2) implies (1) in \cref{MainConj}] 
