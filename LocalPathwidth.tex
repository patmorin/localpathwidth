...
then $G$ has a tree decomposition $(B_a \subseteq V(G):a\in V(T))$, of
...
\begin{proof}
  ...
  $C_i$ that contains $v$, the tree decomposition $(T_i,(B_a:a\in V(T_i)))$ 
  has at least
...
To obtain our good tree decomposition $(T,(B_a:a\in V(T)))$ of a 2-connected
