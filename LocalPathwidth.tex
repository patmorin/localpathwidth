...
\end{enumerate}
This recursive process may produce pairs of S-nodes $a$ and $b$ with a
common P-node neighbour $c$.  If this happens and $H_c$ contains exactly
two virtual edges and no real edge, then we eliminate $c$ and merge $a$
and $b$ into a single S-node.
